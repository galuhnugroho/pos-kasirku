        ...
        <div class="row match-height">
            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form action="{{ route('admin.products.store') }}" method="POST" class="form form-vertical"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="first-name-vertical"
                                                ...
                                                is-invalid
                                            @enderror"
                                                name="stock" placeholder="Stok" value="{{ old('stock') }}">
                                            @error('stock')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="first-name-vertical"
                                                ...
                                                is-invalid
                                            @enderror"
                                                name="barcode" placeholder="Barcode" value="{{ old('barcode') }}">
                                            @error('barcode')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="Deskripsi" id="exampleFormControlTextarea1" rows="3">{{ old('description') }}</textarea>
                                        </div>
                                    </div>
